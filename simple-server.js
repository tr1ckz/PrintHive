...
const modelRoutes = require('./server/routes/models');
const createPrinterRouter = require('./server/routes/printers');
...
app.use(createPrinterRouter({
  ...
  go2rtcConfigPath,
  getPrinterTransferJob: () => printerTransferJob,
}));
