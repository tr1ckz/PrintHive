...
export const dashboardWidgetRegistry: DashboardWidgetRegistryItem[] = [
  ...
  { id: 'materialUsage', title: 'Material Usage' },
...
export const defaultDashboardLayouts: Layouts = {
  lg: [
    ...
    { i: 'activityStream', x: 5, y: 11, w: 7, h: 8, minW: 5, minH: 6 },
  ...
  sm: [
    ...
    { i: 'fleetAlerts', x: 0, y: 16, w: 6, h: 5, minW: 3, minH: 4 },
    { i: 'backgroundJobs', x: 0, y: 21, w: 6, h: 6, minW: 3, minH: 5 },
    { i: 'upcomingSchedule', x: 0, y: 27, w: 6, h: 6, minW: 4, minH: 5 },
    { i: 'activityStream', x: 0, y: 33, w: 6, h: 8, minW: 4, minH: 6 },
    { i: 'failureWatch', x: 0, y: 41, w: 6, h: 6, minW: 4, minH: 5 },
    { i: 'mqttStatus', x: 0, y: 47, w: 6, h: 5, minW: 4, minH: 4 },
  ],
  xs: [
    ...
    { i: 'fleetAlerts', x: 0, y: 16, w: 4, h: 5, minW: 2, minH: 4 },
    { i: 'backgroundJobs', x: 0, y: 21, w: 4, h: 6, minW: 2, minH: 5 },
    { i: 'upcomingSchedule', x: 0, y: 27, w: 4, h: 6, minW: 2, minH: 5 },
    { i: 'activityStream', x: 0, y: 33, w: 4, h: 8, minW: 2, minH: 6 },
    { i: 'failureWatch', x: 0, y: 41, w: 4, h: 6, minW: 2, minH: 5 },
    { i: 'mqttStatus', x: 0, y: 47, w: 4, h: 5, minW: 2, minH: 4 },
  ],
  xxs: [
    ...
    { i: 'fleetAlerts', x: 0, y: 16, w: 2, h: 5, minW: 2, minH: 4 },
    { i: 'backgroundJobs', x: 0, y: 21, w: 2, h: 6, minW: 2, minH: 5 },
    { i: 'upcomingSchedule', x: 0, y: 27, w: 2, h: 6, minW: 2, minH: 5 },
    { i: 'activityStream', x: 0, y: 33, w: 2, h: 8, minW: 2, minH: 6 },
    { i: 'failureWatch', x: 0, y: 41, w: 2, h: 6, minW: 2, minH: 5 },
    { i: 'mqttStatus', x: 0, y: 47, w: 2, h: 5, minW: 2, minH: 4 },
  ],
};
...
const WIDGET_SNAP_PROFILES: Record<DashboardWidgetId, SnapProfile> = {
  ...
  materialUsage: { widths: [3, 4, 5, 6], heights: [4, 5, 6, 7] },
