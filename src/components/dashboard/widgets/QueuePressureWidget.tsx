  ...
  return (
    <div className="flex h-full flex-col gap-4">
      ...
      <div className={`grid gap-3 text-center ${density === 'compact' ? 'grid-cols-3' : 'grid-cols-3'}`}>
        <div className="rounded-[4px] border border-neutral-800 bg-neutral-900 px-3 py-2.5">
      ...
      <div className="mt-auto grid grid-cols-1 gap-2">
        <button
          type="button"
          onClick={onRefresh}
          className="rounded-[4px] border border-orange-500 bg-orange-500 px-3 py-2.5 text-[10px] font-semibold uppercase tracking-[0.1em] text-white hover:bg-orange-600"
        >
          Refresh Inputs
        </button>
        {density !== 'compact' ? (
