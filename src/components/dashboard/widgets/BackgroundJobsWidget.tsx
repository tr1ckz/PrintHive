      ...
      {visibleJobs.length === 0 ? (
        ...
        <div className="space-y-2">
          {visibleJobs.map((job) => {
            ...
            return (
              <div key={job.id} className="rounded border border-white/15 bg-white/[0.03] p-2">
                ...
                <p className="mt-1 text-[10px] uppercase tracking-[0.08em] text-white/50">{job.completed} done | {job.failed} failed</p>
              </div>
            );
          })}
        </div>
