...
export const API_ENDPOINTS = {
  ...
  PRINTERS: {
    ...
    DISCOVER_MISSING_IPS: `${API_BASE_URL}/api/printers/discover-missing-ips`,
  ...
  LIBRARY: {
    ...
    BULK_DELETE: `${API_BASE_URL}/api/library/bulk-delete`,
    BULK_DELETE_STATUS: `${API_BASE_URL}/api/library/bulk-delete-status`,
    BULK_DELETE_CANCEL: `${API_BASE_URL}/api/library/bulk-delete-cancel`,
